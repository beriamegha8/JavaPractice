...
public class WrapEx {
    public static void main(String[] args){
        ...
        int a=20;
        System.out.println("Value of a without autoboxing: "+a); //20
        ...
        //Value of i without autoboxing: 20
        System.out.println("Value of a after autoboxing: "+ String.valueOf(a)); //a, here is automatically unboxed to integer string + int = string
